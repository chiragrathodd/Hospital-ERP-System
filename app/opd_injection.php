   ...
   <div class="col-sm-12">
    <div class="home-tab">
     <div class="card">
      ...
      <table class="display table" style="width:100%;" id="myTable">
       <thead style=" background-color:#e600ac; color:white;">
        <tr>
         ...
         <th style="text-align:center; font-size:12px;">OPD Unique no.</th>
         <th style="text-align:center; font-size:12px;">Patient name</th>
         <th style="text-align:center; font-size:12px;">age</th>
         <th style="text-align:center; font-size:12px;">Sex(m/f)</th>
         <th style="text-align:center; font-size:12px;">Address</th>
         <th style="text-align:center; font-size:12px;">Mobile number</th>
         <th style="text-align:center; font-size:12px;">Dignossis</th>
         <th style="text-align:center; font-size:12px;">Injection Details</th>
       </tr> 
     </thead>
     <tbody >
...
<script>
  document.getElementById('downloadBtn').addEventListener('click', function () {
    var customFilename = 'OPD Injection';
