  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="d-sm-flex align-items-center   justify-content-between border-bottom">
     <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link"  data-bs-toggle="" href="Madicine" role="tab" aria-selected="true" style=" font-size:14px;">Where List</a>
      </li>
    </ul>
  </div><br>
  <div class="row">
   <div class="col-sm-12">
    <div class="home-tab">
         ...
         <div class="form-check">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#dept" data-bs-whatever="@getbootstrap"  style="background-color:#e600ac; height: 34px; color:white; float: right; ">Add Where</button>
              <div class="modal fade" id="dept" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="dept">Add Where</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body form-group">
                      <form method="POST">
                        <div class="mb-3">
                          <label for="Madicine-name" class="col-form-label">Add Where</label>
                      ...
                      <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary" name="btn_where"value="Add Where">
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <?php
              if(isset($_POST['btn_where']))
              {
                include('../databases/config.php');
                $name=$_POST['Madicinelist'];
                $qry="INSERT INTO `cwhere`VALUES ('','$name')";
                $res=mysqli_query($q,$qry);
                if($res)
                {
                 echo '<script>alert("Where add successfully");window.location="where";</script>';
               }
             }
             ?>
           </div>
     ...
     <table id="example" class="display table dataTables" style="width:100%;">
       <thead style=" background-color:#e600ac; color:white;">
        <tr>
         ...
         <th style="text-align:left; font-size:12px;">Where Name</th>
     ...
     <tbody >
      <?php 
      include("../databases/config.php");
      $sql = mysqli_query($q,"select * from cwhere");
      ...
      while ($dd = mysqli_fetch_array($sql))
      {
        ...
        <td>  
         <button class='btn btn-primary editbtn' type='button' data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" 
          ...
          <a class="btn btn-primary" href="delete.php?id=<?php echo $dd[0]?>&page=wherelist" style="height: 32px; color:white;"><i class="mdi mdi-delete"></i></a>
        </td>
        <?php
        echo "</tr>";
...
<!--===========================Edit Model Start====================================-->
     <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Where</h5>
          </div>
          <div class="modal-body">
            <form method="POST">
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Where Name</label>
...
if(isset($_POST["btn_update"]))
{
  ...
  $id = $_POST['txt_id'];
  $one = $_POST['txt_name'];
  $query = "UPDATE cwhere SET name='$one' WHERE id='$id'";
  $result = mysqli_query($q,$query);
  if($result)
  {
   echo "<script>window.location='where.php';</script>";
 }
 else
 {
