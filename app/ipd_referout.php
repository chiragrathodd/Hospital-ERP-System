      ...
      <table class="table" id="myTable">
        <thead>
          <tr>
            ...
            <th scope="col">Reffer To Hospital Name</th>
            <th scope="col">Purpose Of Refference</th>
            <th scope="col">Receiving Doctore Name</th>
...
<script>
    document.getElementById('downloadBtn').addEventListener('click', function () {
        var customFilename = 'IPD Refer Out Procedure';
