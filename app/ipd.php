          ...
          <div class="card-body">
           ...
           <div class="table-responsive">
             ...
             <table id="example" class="display table" style="width:100%;">
               <thead style=" background-color:#e600ac; color:white;">
                <tr>
                 ...
                 <th style="text-align:left; font-size:12px;">Complaint</th>
             ...
             <tbody>
              ...
              $sql = mysqli_query($q,"select * from ipd");
              $i = 1;
              while ($dd = mysqli_fetch_assoc($sql))
              {
                ...
                {
                  echo "<td><a href='ipd_form.php?id={$dd['id']}& name={$dd['name']}&mobile={$dd['mobile']}&village={$dd['village']}&sex={$dd['sex']}&subvillage={$dd['subvillage']}' class='btn btn-warning'  style='height: 32px; background-color: white; color:#e600ac;'>{$dd['status']}</a></td>";
                }
                else
                {
                ...
                ?>
                    ...
                    <td>  
                      <a class='btn btn-primary' href="offer_update.php?id=<?php echo $row['id']; ?>&status=1" role='button' style='height: 32px; background-color: white; color:#8600b3;' aria-expanded='false'><i class="mdi mdi-pencil"></i></a>
                      <a class="btn btn-primary" href="delete.php?id=<?php echo $dd['id']; ?>&page=ipdlist" style="height: 32px; color:white;"><i class="mdi mdi-delete"></i></a>
                    </td>
                  </td>
                  <?php
                  echo "</tr>";
