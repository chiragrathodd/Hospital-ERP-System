      ...
      <table id="example" class="display table" style="width:100%;">
       <thead style=" background-color:#e600ac; color:white;">
        <tr>
         ...
         <th style="text-align:center; font-size:12px;">RECEIVE FROM</th>
         <th style="text-align:center; font-size:12px;">BATCH NO</th>
         <th style="text-align:center; font-size:12px;">EXP DATE</th>
         <th style="text-align:center; font-size:12px;">RECEIVE QUANTITY</th>
         <th style="text-align:center; font-size:12px;">ISSUE</th>
         <th style="text-align:center; font-size:12px;">BALANCE</th>
         <th style="text-align:center; font-size:12px;">remarks</th>
         <th style="text-align:center; font-size:12px;">SIGNATURE</th>
         <th style="text-align:center; font-size:12px;"></th>
