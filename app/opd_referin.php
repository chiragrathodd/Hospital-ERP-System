      ...
      <table id="example" class="display table" style="width:100%;">
       <thead style=" background-color:#e600ac; color:white;">
        <tr>
         ...
         <th style="text-align:center; font-size:12px;">Reff DATE</th>
         <th style="text-align:center; font-size:12px;">PATIENT NAME</th>
         <th style="text-align:center; font-size:12px;">Age</th>
         <th style="text-align:center; font-size:12px;">Sex</th>
         <th style="text-align:center; font-size:12px;">Address</th>
         <th style="text-align:center; font-size:12px;">Mobile</th>
         <th style="text-align:center; font-size:12px;">REFER FROM</th>
         <th style="text-align:center; font-size:12px;">REASON FOR REFER</th>
         <th style="text-align:center; font-size:12px;">FOLLOW UP</th>
