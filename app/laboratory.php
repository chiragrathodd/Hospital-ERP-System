  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="d-sm-flex align-items-center   justify-content-between border-bottom">
     <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link"  data-bs-toggle="" href="Diagnosis" role="tab" style=" font-size:14px;" aria-selected="true">Lab List</a>
      </li>
      <li class="nav-item">
        <a class="nav-link  " data-bs-toggle="" href="other_list" style=" font-size:14px;" role="tab"  aria-selected="true" >Lab List</a>
      </li>
    </ul>
  </div><br>
  <div class="row">
