       ...
       <div class="table-responsive">
        <form method="POST">
         <div class="form-check">
          <div class="row">
            <div class="col-md-12">
              <button type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#dept" data-bs-whatever="@getbootstrap"  style="background-color:#e600ac; height: 34px; color:white; float: right; ">Add Department</button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="dept"id="Department-name">
                        </div>
                      </div>
                    ...
                    if(isset($_POST['add_dept']))
                    {
                      ...
                      $name=$_POST['dept'];
                      $qry="INSERT INTO `deptlist`VALUES ('','$name')";
                      $res=mysqli_query($q,$qry);
                      if($res)
                      {
                       echo '<script>alert("Department add successfully");window.location="user";</script>';
                     }
                   }
                   ?>
...
<tbody >
  <?php 
  include("../databases/config.php");
  $sql = mysqli_query($q,"select * from deptlist");
  ...
  while ($dd = mysqli_fetch_array($sql))
  {
    ...
    <td>  
      ...
      <a class="btn btn-primary" href="delete?id=<?php echo $dd[0]; ?>&page=user_departmentlist" style="height: 32px; color:white;"><i class="mdi mdi-delete"></i></a>
    </td>
    <?php
    echo "</tr>";
  ...
  ?>
    ...
    if(isset($_POST['btn_update']))
    {
        ...
        $u_qry = mysqli_query($q,"update deptlist set departmentname='$u_name' where id='$u_id' ");
        if($u_qry)
        {
